...
::: {.fragment .fade-in-then-out}
![](images/flex.png){width=60% fig-align="center"}
:::
...
:::{.column}
![](images/lecture_3/dplyr.png){width=40% fig-align="center"}
:::
...
## ChatGPT {background-image="images/chat-gpt-background-free-vector.jpg"}

## ChatGPT en Rstudio

El paquete [gptstudio](https://github.com/MichelNivard/gptstudio) nos permite interactuar con chatGPT dentro del entorno de RStudio. Sin embargo, actualmente se pide tener una cuenta de pago para poder utilizar la [API](https://platform.openai.com/account/api-keys).
...
1.  Bajar el siguiente archivo: [\_hello.qmd](https://quarto.org/docs/get-started/hello/rstudio/_hello.qmd)
...
| ```                                                                      |                                                                                                                     |
+--------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| ``` markdown                                                             | ![Caption](images/ifop.png){fig-alt="Logo IFOP"}                                                                    |
| ![Caption](images/ifop.png)                                              |                                                                                                                     |
| ```                                                                      |                                                                                                                     |
+--------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| ``` markdown                                                             | [![Caption](images/ifop.png)](https://quarto.org)                                                                   |
| [![Caption](images/ifop.png)](https://quarto.org)                        |                                                                                                                     |
| ```                                                                      |                                                                                                                     |
+--------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| ``` markdown                                                             | [![Caption](images/ifop.png "An elephant"){fig-alt="A line drawing of an elephant."}](https://quarto.org)           |
| [![Caption](images/ifop.png)](https://quarto.org "Logo IFOP")            |                                                                                                                     |
| ```                                                                      |                                                                                                                     |
+--------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| ``` markdown                                                             | [![](images/ifop.png){fig-alt="A line drawing of an elephant."}](https://quarto.org)                                |
| [![](images/ifop.png){fig-alt="Alt text"}](https://quarto.org)           |                                                                                                                     |
| ```                                                                      |                                                                                                                     |
+--------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
